package com.mo_samy.mvp.adapters
...
import com.mo_samy.mvp.ui.DetailsActivity


class ProductsAdapter(private val context :Context, private var items :List<Data>)
